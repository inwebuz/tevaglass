        ...
        $(document).ready(function () {
            ...
            $m_modal.on('show.bs.modal', function(e, data) {
                ...
                if (_adding) {
                    ...
                    if(translatable){
                        $_title_str_i18n = $("#title" + id + "_i18n").val();
                        $_url_str_i18n = $("#url" + id + "_i18n").val();
                    }
                ...
                if (translatable) {
                    $m_title_i18n.val($_title_str_i18n);
                    $m_url_i18n.val($_url_str_i18n);
