...
<title>{{ __('main.order') }} #{{ $order->id }}</title>
</head>
...
<td class="content-cell" style="padding: 30px 20px;">
    <h1>
        {{ config('app.name') }} - {{ __('main.order') }} #{{ $order->id }}
    </h1>
    <p>
        <strong>{{ __('main.order_id') }}:</strong> {{ $order->id }} <br />
        <strong>{{ __('main.form.your_name') }}:</strong> {{ $order->name }} <br />
        ...
        <a href="{{ $order->url }}" target="_blank">{{ __('main.view_more') }}</a> <br />
    </p>
    <div>
